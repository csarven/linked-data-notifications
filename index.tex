  ...
  \begin{document}
                ...
                Linked Data Notifications: a resource-centric communication protocol
                    ...
                    \begin{description}
  \item[Authors] \empty Sarven Capadisli\empty 1\empty ✊\empty Amy Guy\empty 2\empty 🐦\empty Christoph Lange\empty 1\empty ∫\empty Sören Auer\empty 1\empty ⚛\empty Tim Berners-Lee\empty 3\empty 🕸
    \end{description}
